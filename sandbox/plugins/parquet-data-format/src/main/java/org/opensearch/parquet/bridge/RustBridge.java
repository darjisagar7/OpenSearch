...
public class RustBridge {
    ...
    public static RowIdMapping mergeParquetFilesInRust(List<Path> inputFiles, String outputFile, String indexName) {
        ...
        try (var call = new NativeCall()) {
            ...
            return readAndFreeMergeResult(outMappingPtr, outMappingLen, outGenKeysPtr, outGenOffsetsPtr, outGenSizesPtr, outGenCount);
        } catch (IOException e) {
