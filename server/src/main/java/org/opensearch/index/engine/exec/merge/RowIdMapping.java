 ...
 * - file_5 (2 rows): offset=0, mapping[0]=0, mapping[1]=1
 * - file_0 (3 rows): offset=2, mapping[2]=2, mapping[3]=3, mapping[4]=4
...
public final class RowIdMapping {
    ...
    /**
     * Looks up the new row ID for a given RowId.
     */
    public long getNewRowId(RowId oldRowId) {
        if (oldRowId == null) return -1L;
